          ...
          >
            ...
            <div className="text-white" style={{ fontSize: '14px', fontWeight: 400, lineHeight: '20px' }}>
              ...
              {selectedCity?.info.extra2 && (
                <>
                  <br /><br />
                  <span className="font-bold">{selectedCity.info.extra2.name === 'Taboão da Serra' ? t(`worldmap.filial.taboao`) : selectedCity.info.extra2.title}</span>
                  <br />
              ...
              {selectedCity?.info.extra3 && (
                <>
                  <br /><br />
                  <span className="font-bold">{selectedCity.info.extra3.name === 'Campinas' ? t(`worldmap.filial.campinas`) : selectedCity.info.extra3.title}</span>
                  <br />

...
export const translations: Translations = {
  pt: {
    ...
    'home.stats.card3.number': '+40.000',
    ...
    'home.solutions.svg.mobile.desc1': 'Oferecemos muito mais do que logística: atuamos como um parceiro estratégico na jornada da saúde. \nAtuamos em três áreas complementares, conectadas por tecnologia própria, DRS360, e por um compromisso comum: entregar inteligência, confiança e cuidado.',
    ...
    'grupo.impact.card1.number': '+40',
    'grupo.impact.card1.unit': 'mil',
    'grupo.impact.card1.title': 'pacientes',
    'grupo.impact.card1.desc1': 'atendidos por ano',
    'grupo.impact.card1.desc2': '',

    'grupo.impact.card2.number': '+500',
    'grupo.impact.card2.title': 'protocolos',
    'grupo.impact.card2.desc1': 'sob gestão apoiados em',
    'grupo.impact.card2.desc2': 'todas as fases',
    ...
    'cts.text3': 'Cada etapa é pensada para garantir segurança, rastreabilidade e conformidade com padrões internacionais e agências reguladoras, GDP, ICH-GCP, FDA, EMA, ANVISA e ANMAT.',
    ...
    'drs360.bottom.cta': 'Conheça o DRS360',
    ...
    'drs360.security.bullet4': '• Compliance FDA, EMA, ANVISA e',
    'drs360.security.bullet4b': 'ANMAT, LGPD/GDPR, ISO27001/27701',
    ...
    'drs360.security.mobile.bullet4': '• Compliance FDA, EMA, ANVISA e',
    'drs360.security.mobile.bullet4b': 'ANMAT, LGPD/GDPR, ISO27001/27701',
    ...
    'cts.svg4.desc1': 'Embalagem, etiquetagem e',
    ...
    'cts.sol1.dif4': 'Compliance com GDP, FDA, EMA, ANVISA e ANMAT',
    ...
    'cts.sol2.dif3': 'Segregação por protocolo',
    ...
    'cts.sol4.desc': 'Embalagem, etiquetagem e cegamento de medicamentos investigacionais em ambiente GMP, com total rastreabilidade.',
    'cts.sol4.dif1': 'Transporte Especial IATA',
    ...
    'pcs.svg6.desc4': '',
    'pcs.svg7.line1': 'Serviços',
    'pcs.svg7.line2': 'logísticos voltados',
    'pcs.svg7.line3': 'para SAC',
    'pcs.svg7.desc1': 'Especialista em serviços de atendimento',
    'pcs.svg7.desc2': 'e logística reversa/devolução de produtos',
    'pcs.svg7.desc3': 'para o consumidor final.',
    'pcs.svg7.desc4': '',
    'pcs.svg7.desc5': '',
    'pcs.svg8.line1': 'Armazenagem',
    'pcs.svg8.line2': 'Especializada',
    'pcs.svg8.line3': '',
    'pcs.svg8.desc1': 'Armazenagem e distribuição',
    'pcs.svg8.desc2': 'especializada de insumos e',
    'pcs.svg8.desc3': 'equipamentos médicos.',
    'pcs.svg8.desc4': '',
    'pcs.svg8.desc5': '',

    // PCS Solution Modal keys
    'pcs.sol1.title': 'Programa de Suporte ao Paciente (PSP)',
    'pcs.sol1.desc': 'Gestão integral de programas de suporte para pacientes em tratamento contínuo, com foco em adesão, orientação e acompanhamento.',
    'pcs.sol1.dif1':'Estrutura dedicada de atendimento ao paciente',
    'pcs.sol1.dif2':'Protocolos personalizados por terapia e perfil de paciente',
    'pcs.sol1.dif3':'Monitoramento contínuo de adesão ao tratamento',
    'pcs.sol1.dif4':'Integração com stakeholders (indústria, prescritores e cuidadores)',
    'pcs.sol1.dif5':'Conformidade com diretrizes regulatórias e de privacidade',
    ...
    'pcs.sol2.dif2':'Equipe treinada para orientação e suporte ao paciente ',
    'pcs.sol2.dif3':'Gestão de interações e registro de atendimentos ',
    'pcs.sol2.dif4':'Integração com programas de suporte e logística ',
    'pcs.sol2.dif5':'Atendimento multicanal ',
    'pcs.sol2.dest1':'Experiência humanizada e qualificada ',
    'pcs.sol2.dest2':'Padronização e rastreabilidade dos atendimentos ',
    'pcs.sol2.dest3':'Suporte contínuo ao longo do tratamento ',

    'pcs.sol3.title': 'Terapias Inovadoras',
    'pcs.sol3.desc': 'Suporte logístico e assistencial para terapias avançadas e de alta complexidade, garantindo controle, segurança e integridade do tratamento.',
    'pcs.sol3.dif1':'Operação adaptada para terapias sensíveis e complexas ',
    'pcs.sol3.dif2':'Controle rigoroso de cadeia e condições especiais ',
    'pcs.sol3.dif3':'Integração entre logística e atendimento ao paciente ',
    'pcs.sol3.dif4':'Protocolos específicos por tipo de terapia',
    'pcs.sol3.dif5':'Conformidade com exigências regulatórias nacionais e internacionais ',
    'pcs.sol3.dest1':'Segurança na administração de terapias complexas ',
    'pcs.sol3.dest2':'Redução de riscos operacionais ',
    'pcs.sol3.dest3':'Gestão integrada da jornada terapêutica ',

    'pcs.sol4.title': 'Direct-to-Patient',
    'pcs.sol4.desc': 'Entrega direta de medicamentos ao paciente, com segurança, rastreabilidade e controle de ponta a ponta.',
    'pcs.sol4.dif1':'Logística especializada para entrega domiciliar ',
    'pcs.sol4.dif2':'Monitoramento de transporte e condições do produto ',
    'pcs.sol4.dif3':'Rastreabilidade completa da entrega ',
    'pcs.sol4.dif4':'Integração com programas de suporte ao paciente ',
    'pcs.sol4.dif5':'Coordenação com a equipe assistencial ',
    ...
    'pcs.sol5.dif2':'Integração de medicamentos, insumos e dispositivos ',
    'pcs.sol5.dif3':'Controle rigoroso de qualidade e rastreabilidade ',
    'pcs.sol5.dif4':'Preparação alinhada à logística e à jornada do paciente ',
    'pcs.sol5.dif5':'Flexibilidade para diferentes terapias e programas ',
    'pcs.sol5.dest1':'Padronização e segurança na preparação dos kits ',
    'pcs.sol5.dest2':'Agilidade na disponibilização para o paciente ',
    'pcs.sol5.dest3':'Integração entre operação logística e cuidado ',

    'pcs.sol6.title': 'Transporte especializado',
    'pcs.sol6.desc': 'Transporte dedicado para medicamentos e insumos sensíveis e amostras biológicas, com controle rigoroso e monitoramento contínuo.',
    'pcs.sol6.dif1':'Cadeia logística com controle de temperatura ',
    'pcs.sol6.dif2':'Monitoramento em tempo real ',
    'pcs.sol6.dif3':'Protocolos para produtos sensíveis e de alto valor ',
    'pcs.sol6.dif4':'Conformidade com normas regulatórias ',
    'pcs.sol6.dif5':'Integração com armazenagem e distribuição ',
    'pcs.sol6.dest1':'Garantia de integridade dos produtos ',
    'pcs.sol6.dest2':'Redução de riscos logísticos ',
    'pcs.sol6.dest3':'Controle de ponta a ponta da operação',

    'pcs.sol7.title': 'Serviços logísticos voltados para SAC (Serviço de Atendimento ao Consumidor)',
    'pcs.sol7.desc': 'Especialista em serviços de atendimento e logística reversa/devolução de produtos para o consumidor final.',
    'pcs.sol7.dif1':'Logística Reversa e Ressarcimento: Coleta de produtos diretamente na casa do paciente para devolução ou troca, e entrega de itens de substituição ou ressarcimento ',
    'pcs.sol7.dif2':'Armazenamento de produtos para garantir agilidade na distribuição ',
    'pcs.sol7.dif3':'Reconciliação de produtos reclamados para devolução ao fabricante ',
    'pcs.sol7.dif4':'Cadeia logística com controle de temperatura ',
    'pcs.sol7.dif5':'Monitoramento em tempo real ',
    'pcs.sol7.dif6':'Conformidade com normas regulatórias ',
    'pcs.sol7.dest1':'Garantia de integridade dos produtos ',
    'pcs.sol7.dest2':'Redução de riscos logísticos ',
    'pcs.sol7.dest3':'Controle de ponta a ponta da operação',

    'pcs.sol8.title': 'Armazenagem Especializada',
    'pcs.sol8.desc': 'Armazenagem e distribuição especializada de insumos e equipamentos médicos. ',
    'pcs.sol8.dif1':'Logística especializada para entrega domiciliar ou centro de saúde ',
    'pcs.sol8.dif2':'Monitoramento de transporte e condições do produto ',
    'pcs.sol8.dif3':'Rastreabilidade completa da entrega ',
    'pcs.sol8.dest1':'Comodidade e segurança para o cliente final ',
    'pcs.sol8.dest2':'Garantia de integridade do produto ',
    'pcs.sol8.dest3':'Eficiência na última milha da entrega',

    // TIS SVG text keys
    'tis.svg1.line1': 'Cadeia Fria e',
    'tis.svg1.line2': 'Embalagens',
    'tis.svg1.line3': 'Reutilizáveis',
    ...
    'tis.svg3.line1': '',
    'tis.svg3.line2': 'Telemetria',
    'tis.svg3.line3': '',
    'tis.svg3.desc1': 'Monitoramento contínuo de',
    'tis.svg3.desc2': 'temperatura, umidade e',
    'tis.svg3.desc3': 'localização em tempo real.',
    'tis.svg3.desc4': '',
    'tis.svg3.desc5': '',
    'tis.svg3.desc6': '',
    ...
    'tis.sol1.desc': 'Soluções integradas de logística e cadeia fria, combinadas com embalagens Shield Box de alta performance reutilizáveis, desenvolvidas para garantir estabilidade térmica e integridade de produtos sensíveis.',
    ...
    'tis.sol1.dif3': 'Performance acima de 96 horas',
    ...
    'tis.sol2.dif1': 'Certificações nacionais e internacionais (licenciamento IATA)',
    'tis.sol2.dif2': 'Transporte rodoviário e aéreo em conformidade para todas as classes de produtos',
    'tis.sol2.dif3': 'Operação dedicada para cadeia fria e Modal Fly Cargueiro, com integração a sistemas de rastreabilidade ',
    ...
    'tis.sol3.dif6': 'Emissão de relatórios em PDF e suporte à tomada de decisão operacional',
    'tis.sol3.dif7': 'Plataforma Bip Track validada e em conformidade regulatória',
    'tis.sol3.dest1': 'Visibilidade total da operação em tempo real',
  ...
  en: {
    ...
    // Home - Hero
    'home.hero.title': 'Connecting Science and People',
    'home.hero.description': 'We deliver results and craft custom solutions for the pharmaceutical industry, CROs and clinical research centers, powered by our proprietary technology.',
    ...
    // Home - Stats
    'home.stats.title.line1': 'Delivering Impact.',
    'home.stats.title.line2': 'Transforming the Future of Research.',
    'home.stats.card1.number': '+500',
    'home.stats.card1.line1': 'Active',
    'home.stats.card1.line2': 'Protocols',
    'home.stats.card1.desc1': 'Driving innovation across',
    'home.stats.card1.desc2': 'diverse clinical phases',
    'home.stats.card1.desc3': 'and therapeutic fields.',
    'home.stats.card2.number': '+100',
    ...
    // Home - DRS 360 Carousel
    'home.drs360.slide1.title': 'DRS360: Real-Time, 24/7 Visibility',
    'home.drs360.slide1.description': 'Our proprietary platform delivers full traceability and customized study dashboards.',
    'home.drs360.slide2.title': 'Full Control of Your Operations',
    'home.drs360.slide2.description': 'Manage every process seamlessly: integrated, efficient, and transparent.',

    // Home - Solutions SVG
    'home.solutions.svg.title1': 'Intelligent solutions for every',
    'home.solutions.svg.title2': 'stage of the healthcare chain',
    'home.solutions.svg.desc1': 'Innovation, technology and compassion come together',
    'home.solutions.svg.desc2': 'to drive life-changing health projects.',
    ...
    // Footer
    'footer.cta.title.line1': 'We connect your goals',
    ...
    'solucoes.text1': 'Our solutions combine validated infrastructure, real-time traceability, and truly humanized care to support critical projects, clinical studies, and patient home deliveries.',
    ...
    'grupo.impact.card1.desc1': 'treated per year',
    'grupo.impact.card1.desc2': '',

    'grupo.impact.card2.number': '+500',
    'grupo.impact.card2.title': 'protocols',
    'grupo.impact.card2.desc1': 'under management, supported',
    'grupo.impact.card2.desc2': 'at every stage',
    ...
    'grupo.impact.card5.desc1': 'made within 24 hours',
    'grupo.impact.card5.desc2': '',

    'grupo.impact.card6.number': 'National',
    'grupo.impact.card6.unit': '',
    'grupo.impact.card6.title': 'and international',
    ...
    'cts.text3': 'Each stage is designed to guarantee safety, traceability and compliance with international standards and regulatory agencies, GDP, ICH-GCP, FDA, EMA, ANVISA and ANMAT. ',
    ...
    'tis.hero.tag': 'TIS',
    'tis.hero.title': 'Thermo Integrated Services',
    'tis.hero.description': 'Your products have improved - and we have evolved along with them. We offer technology, precision and logistical intelligence on a par with the most innovative therapies.',
    ...
    // Solucoes - PCS diff items
    'solucoes.pcs.diff.item1': '• Managed by healthcare professionals,',
    'solucoes.pcs.diff.item1b': 'ensuring precision and clinical excellence.',
    'solucoes.pcs.diff.item2': '• Increased adherence and reduced',
    'solucoes.pcs.diff.item2b': 'treatment losses.',
    'solucoes.pcs.diff.item3': '• Humanized care seamlessly integrated',
    'solucoes.pcs.diff.item3b': 'with specialized logistics.',
    'solucoes.pcs.diff.item4': '•  Individualized monitoring powered',
    'solucoes.pcs.diff.item4b': 'by DRS360.',

    'solucoes.pcs.svg.desc1mob': 'We provide specialized services that enable access to and support for innovative, highly complex therapies.\nComprehensive management of support, care and marketing programs - bringing together humanized care, health professionals, technology and logistics.',
    ...
    'drs360.func5.line4': '(FDA, EMA, ANVISA & ANMAT',
    'drs360.func5.line5': 'compliance)',
    ...
    'drs360.security.mobile.bullet4': '• Compliance FDA, EMA, ANVIS e ANMAT,',
    ...
    'cts.sol1.desc': 'We source and import reference drugs for clinical trials in any phase, ensuring complete traceability, regulatory compliance, and strict control from acquisition to delivery.',
    'cts.sol1.dif1': 'Global sourcing with a qualified supplier network.',
    'cts.sol1.dif2': 'Expert handling of import and customs procedures.',
    'cts.sol1.dif3': 'Real-time traceability powered by DRS360. ',
    'cts.sol1.dif4': 'Compliance with GDP, FDA, EMA, ANVISA and ANMAT standards. ',
    'cts.sol1.dif5': 'Temperature-controlled management throughout the supply chain.',
    'cts.sol1.dest1': 'Fast and secure access to comparator drugs.',
    'cts.sol1.dest2': 'Minimized regulatory and operational risks.',
    'cts.sol1.dest3': 'Comprehensive, end-to-end chain oversight.',

    'cts.sol2.title': 'Storage services',
    'cts.sol2.desc': 'Specialized warehousing with temperature control for investigational products, ensuring product integrity, security, and full traceability throughout the storage process.',
    'cts.sol2.dif1': 'Temperature-controlled zones for all storage requirements.',
    'cts.sol2.dif2': '24/7 environmental monitoring and alert systems.',
    'cts.sol2.dif3': 'Segregation of materials by protocol.',
    'cts.sol2.dif4': 'Real-time inventory management through DRS360.',
    'cts.sol2.dest1': 'Compliance with Good Storage Practices (GSP)',
    'cts.sol2.dest2': 'Complete traceability for each batch and product.',
    'cts.sol2.dest3': 'Automated, on-demand stock and environmental reports.',

    'cts.sol3.title': 'Global official importer services',
    'cts.sol3.desc': 'Importation and registration of products for clinical research, supported by complete regulatory management and international expertise.',
    'cts.sol3.dif1': 'Active import licenses across multiple countries.',
    'cts.sol3.dif2': 'Comprehensive documentation and regulatory management.',
    'cts.sol3.dif3': 'Customs clearance handled by healthcare-specialized experts.',
    'cts.sol3.dif4': 'Proven experience with global regulatory authorities.',
    'cts.sol3.dest1': 'Shorter import timelines and operational agility.',
    'cts.sol3.dest2': 'Guaranteed international regulatory compliance.',
    'cts.sol3.dest3': 'Dedicated support from a specialized regulatory team.',

    'cts.sol4.title': 'Packaging, labeling and blinding',
    'cts.sol4.desc': 'Repackaging, labeling, and blinding of investigational drugs in a GMP-certified environment, ensuring product integrity and full traceability throughout all stages.',
    'cts.sol4.dif1': 'IATA Special Cargo.',
    'cts.sol4.dif2': 'Multilingual labeling according to study requirements.',
    'cts.sol4.dif3': 'Capability for both single- and double-blind studies.',
    'cts.sol4.dif4': 'Quality control applied at every processing stage.',
    'cts.sol4.dest1': 'Fully GMP-compliant environment.',
    'cts.sol4.dest2': ' Validated, auditable, and traceable processes.',
    'cts.sol4.dest3': 'Operational flexibility for diverse study protocols.',

    'cts.sol5.title': 'Laboratory kits',
    'cts.sol5.desc': 'Assembly and distribution of customized kits for sample collection and laboratory analysis, ensuring accuracy, quality, and complete traceability.',
    'cts.sol5.dif1': 'Custom kit assembly tailored to each study protocol.',
    'cts.sol5.dif2': 'Use of qualified, tracked, and compliant components.',
    'cts.sol5.dif3': 'Cold-chain distribution when required.',
    'cts.sol5.dif4': 'Integrated inventory management through centralized systems.',
    'cts.sol5.dest1': 'Ready-to-use kits delivered directly to investigational sites.',
    'cts.sol5.dest2': 'Minimized risk of assembly or labeling errors.',
    'cts.sol5.dest3': 'Full traceability for each individual kit and component.',

    'cts.sol6.title': 'Specialized transport',
    'cts.sol6.desc': 'Regulated logistics solutions for the transportation of sensitive clinical materials, ensuring continuous monitoring, safety, and strict compliance throughout the entire journey.',
    'cts.sol6.dif1': 'Qualified fleet dedicated to temperature-sensitive and regulated materials.',
    'cts.sol6.dif2': 'Real-time temperature and transport condition monitoring.',
    'cts.sol6.dif3': 'Optimized routing for efficient delivery to research centers.',
    'cts.sol6.dif4': 'Comprehensive transport documentation and chain-of-custody controls.',
    'cts.sol6.dif5': 'Exception and deviation management ensuring supply integrity.',
    'cts.sol6.dest1': 'Deliveries with full traceability from pickup to destination.',
    'cts.sol6.dest2': 'Compliance with GDP and Good Distribution Practices.',
    'cts.sol6.dest3': 'Custom SLA configurations aligned with each study`s requirements.',
    ...
    'pcs.svg2.line1': 'Consumer',
    'pcs.svg2.line2': 'and Patient',
    ...
    'pcs.svg6.desc4': '',
    'pcs.svg7.line1': 'Consumer',
    'pcs.svg7.line2': 'Service',
    'pcs.svg7.line3': 'Logistics (SAC)',
    'pcs.svg7.desc1': 'Specialized customer service and',
    'pcs.svg7.desc2': 'reverse logistics solutions for',
    'pcs.svg7.desc3': 'end consumers, ensuring convenience,',
    'pcs.svg7.desc4': 'safety, and operational control.',
    'pcs.svg7.desc5': '',
    'pcs.svg8.line1': 'Specialized',
    'pcs.svg8.line2': 'Warehousing',
    'pcs.svg8.line3': '',
    'pcs.svg8.desc1': 'Specialized warehousing and',
    'pcs.svg8.desc2': 'distribution of medical supplies',
    'pcs.svg8.desc3': 'and medical devices. ',
    'pcs.svg8.desc4': '',
    'pcs.svg8.desc5': '',

    'pcs.sol1.title': 'Patient Support Program (PSP)',
    'pcs.sol1.desc': 'Comprehensive management of support programs for patients undergoing continuous treatment, focused on adherence, guidance, and follow-up.',
    'pcs.sol1.dif1': 'Dedicated patient care infrastructure',
    'pcs.sol1.dif2': 'Customized protocols based on therapy type and patient profile',
    'pcs.sol1.dif3': 'Continuous monitoring of treatment adherence',
    'pcs.sol1.dif4': 'Integration with key stakeholders (industry partners, prescribers, and caregivers)',
    'pcs.sol1.dif5': 'Full compliance with regulatory and privacy requirements',
    'pcs.sol1.dest1': 'Improved treatment adherence',
    ...
    'pcs.sol2.dif3': 'Comprehensive interaction management and service record tracking',
    'pcs.sol2.dif4': 'Seamless integration with support programs and logistics',
    'pcs.sol2.dif5': 'Multichannel communication capabilities',
    'pcs.sol2.dest1': 'Humanized and high-quality patient experience',
    ...
    'pcs.sol3.dif3': 'Seamless integration between logistics and patient care',
    'pcs.sol3.dif4': 'Therapy-specific operational and clinical protocols',
    'pcs.sol3.dif5': 'Full compliance with national and international regulatory standards',
    'pcs.sol3.dest1': 'Safe and efficient administration of complex therapies',
    ...
    'pcs.sol4.dif3': 'Complete delivery traceability from origin to destination',
    'pcs.sol4.dif4': 'Seamless integration with patient support programs',
    'pcs.sol4.dif5': 'Close coordination with healthcare and care teams',
    'pcs.sol4.dest1': 'Enhanced convenience and safety for patients',
    ...
    'pcs.sol5.dif3': 'Rigorous quality control and complete traceability',
    'pcs.sol5.dif4': 'Preparation aligned with logistics flows and the patient journey',
    'pcs.sol5.dif5': 'Flexible solutions suitable for multiple therapies and programs',
    'pcs.sol5.dest1': 'Standardized and safe kit preparation process',
    ...
    'pcs.sol6.dif3': 'Specific protocols for handling sensitive and high-value products',
    'pcs.sol6.dif4': 'Full compliance with national and international regulations',
    'pcs.sol6.dif5': 'Seamless integration with warehousing and distribution operations',
    'pcs.sol6.dest1': 'Guaranteed product integrity throughout transport',
    'pcs.sol6.dest2': 'Minimized logistics and handling risks',
    'pcs.sol6.dest3': 'Comprehensive end-to-end operational control',

    'pcs.sol7.title': 'Consumer Service Logistics (SAC)',
    'pcs.sol7.desc': 'Specialized customer service and reverse logistics solutions for end consumers, ensuring convenience, safety, and operational control.',
    'pcs.sol7.dif1':'Reverse logistics and reimbursement services, including product collection directly from the patient’s home for return or exchange, and delivery of replacement or reimbursement items ',
    'pcs.sol7.dif2':'Strategic product storage to ensure fast and agile distribution ',
    'pcs.sol7.dif3':'Reconciliation and management of returned products for manufacturer processing ',
    'pcs.sol7.dif4':'Temperature-controlled logistics network ensuring product quality ',
    'pcs.sol7.dif5':'Real-time shipment and process monitoring ',
    'pcs.sol7.dif6':'Full compliance with all regulatory and quality standards ',
    ...
    'pcs.sol8.title': 'Specialized Warehousing',
    'pcs.sol8.desc': 'Specialized warehousing and distribution of medical supplies and medical devices.',
    'pcs.sol8.dif1':'Specialized logistics for both home and healthcare facility deliveries',
    'pcs.sol8.dif2':'Continuous monitoring of transport and product conditions ',
    'pcs.sol8.dif3':'Complete traceability across the entire delivery process ',
    'pcs.sol8.dest1':'Enhanced convenience and safety for end customers ',
    'pcs.sol8.dest2':'Guaranteed product integrity and compliance with handling standards ',
    'pcs.sol8.dest3':'High efficiency in last-mile distribution',

    // TIS SVG text keys
    'tis.svg1.line1': 'Cold Chain &',
    'tis.svg1.line2': 'Reusable',
    'tis.svg1.line3': 'Packaging',
    ...
    'tis.sol1.dif3': 'Proven thermal performance for durations of up to 96+ hours',
    ...
    'tis.sol2.dif1': 'National and international certifications, including IATA-licensed operations',
    'tis.sol2.dif2': 'Road and air transportation fully compliant with all product classes',
    'tis.sol2.dif3': 'Dedicated cold chain operations — including freighter cargo (Fly Cargo model) - integrated with advanced tracking systems',
    ...
    'tis.sol3.dif3': 'Continuous temperature monitoring capability, ranging from –200°C to +200°C',
    'tis.sol3.dif4': 'Real-time alerts for temperature and humidity excursions',
    'tis.sol3.dif5': 'Seamless integration with traceability systems using ANATEL-certified 4Gh tecnology',
    'tis.sol3.dif6': 'Automated PDF reporting and intelligent operational insights for decision support',
    'tis.sol3.dif7': 'Bip Track platform validated and fully compliant with regulatory requirements',
    'tis.sol3.dest1': 'Complete operational visibility in real time',
  ...
  es: {
    ...
    'home.solutions.svg.title2': 'toda la cadena de salud',
    ...
    'home.solutions.svg.desc4': 'nuestra plataforma propia DRS 360 y guiadas por un',
    ...
    'cts.text3': 'Cada etapa está diseñada para garantizar la seguridad, la trazabilidad y el cumplimiento de estándares internacionales y normativas regulatorias (GDP, ICH-GCP, FDA, EMA, ANVISA y ANMAT).',
    ...
    'drs360.security.mobile.bullet4b': 'e ANMAT, LGPD/GDPR, ISO27001/27701',
    ...
    'cts.sol1.dif4': 'Compliance con GDP, FDA, EMA, ANVISA y ANMAT',
    ...
    'cts.sol2.dif3': 'Segregación por protocolo',
    ...
    'pcs.svg4.line1': 'Entrega Directa',
    'pcs.svg4.line2': 'al Paciente',
    'pcs.svg4.line3': '',
    ...
    'pcs.svg5.line1': 'Ensamblaje de',
    'pcs.svg5.line2': 'Kits para',
    'pcs.svg5.line3': 'Pacientes',
    ...
    'pcs.svg7.line1': 'Servicios',
    'pcs.svg7.line2': 'Logísticos',
    'pcs.svg7.line3': 'para SAC',
    'pcs.svg7.desc1': 'Servicios especializados de atención',
    'pcs.svg7.desc2': 'y logística inversa/devolución de',
    'pcs.svg7.desc3': 'productos para el consumidor final.',
    'pcs.svg7.desc4': '',
    'pcs.svg7.desc5': '',
    'pcs.svg8.line1': 'Almacenamiento',
    'pcs.svg8.line2': 'Especializado',
    'pcs.svg8.line3': '',
    'pcs.svg8.desc1': 'Almacenamiento y distribución',
    'pcs.svg8.desc2': 'especializada de insumos y',
    'pcs.svg8.desc3': 'dispositivos médicos. ',
    'pcs.svg8.desc4': '',
    'pcs.svg8.desc5': '',

    'pcs.sol1.title': 'Programa de Soporte al Paciente (PSP) ',
    'pcs.sol1.desc': 'Gestión integral de programas de soporte para pacientes en tratamiento continuo, con enfoque en la adherencia, la orientación y el seguimiento.',
    'pcs.sol1.dif1': 'Estructura dedicada de atención al paciente',
    'pcs.sol1.dif2': 'Protocolos personalizados por terapia y perfil de paciente',
    'pcs.sol1.dif3': 'Monitoreo continuo de la adherencia al tratamiento',
    'pcs.sol1.dif4': 'Integración con stakeholders (industria, prescriptores y cuidadores)',
    'pcs.sol1.dif5': 'Cumplimiento de directrices regulatorias y de privacidad',
    'pcs.sol1.dest1': 'Mejora de la adherencia terapéutica',
    'pcs.sol1.dest2': 'Reducción del abandono del tratamiento',
    'pcs.sol1.dest3': 'Gestión estructurada de la jornada del paciente',

    'pcs.sol2.title': 'Servicios para Consumidores y Pacientes',
    'pcs.sol2.desc': 'Soluciones especializadas para el soporte directo al paciente, garantizando orientación, seguridad y una experiencia calificada.',
    'pcs.sol2.dif1': 'Central de atención dedicada',
    'pcs.sol2.dif2': 'Equipo capacitado para la orientación y soporte al paciente',
    'pcs.sol2.dif3': 'Gestión de interacciones y registro de atenciones',
    'pcs.sol2.dif4': 'Integración con programas de soporte y logística',
    'pcs.sol2.dif5': 'Atención multicanal',
    'pcs.sol2.dest1': 'Experiencia humanizada y de alta calidad',
    ...
    'pcs.sol3.dif3': 'Integración entre logística y atención al paciente',
    'pcs.sol3.dif4': 'Protocolos específicos por tipo de terapia',
    'pcs.sol3.dif5': 'Cumplimiento de requisitos regulatorios nacionales e internacionales',
    'pcs.sol3.dest1': 'Seguridad en la administración de terapias complejas',
    'pcs.sol3.dest2': 'Reducción de riesgos operativos',
    'pcs.sol3.dest3': 'Gestión integrada de la jornada terapéutica',

    'pcs.sol4.title': 'Entrega Directa al Paciente',
    'pcs.sol4.desc': 'Entrega directa de medicamentos al paciente, con seguridad, trazabilidad y control de extremo a extremo.',
    'pcs.sol4.dif1': 'Logística especializada para entrega domiciliaria',
    'pcs.sol4.dif2': 'Monitoreo del transporte y condiciones del producto',
    'pcs.sol4.dif3': 'Trazabilidad completa de la entrega',
    'pcs.sol4.dif4': 'Integración con programas de soporte al paciente',
    'pcs.sol4.dif5': 'Coordinación con equipos asistenciales',
    'pcs.sol4.dest1': 'Comodidad y seguridad para el paciente',
    ...
    'pcs.sol5.dif3': 'Control estricto de calidad y trazabilidad',
    'pcs.sol5.dif4': 'Preparación alineada con la logística y la jornada del paciente',
    'pcs.sol5.dif5': 'Flexibilidad para diferentes terapias y programas',
    'pcs.sol5.dest1': 'Estandarización y seguridad en la preparación de kits',
    'pcs.sol5.dest2': 'Mayor agilidad en la disponibilidad para el paciente',
    'pcs.sol5.dest3': 'Integración entre operación logística y cuidado',

    'pcs.sol6.title': 'Transporte Especializado',
    'pcs.sol6.desc': 'Transporte dedicado para medicamentos sensibles, insumos y muestras biológicas, con control estricto y monitoreo continuo.',
    'pcs.sol6.dif1': 'Cadena logística con control de temperatura',
    'pcs.sol6.dif2': 'Monitoreo en tiempo real',
    'pcs.sol6.dif3': 'Protocolos para productos sensibles y de alto valor',
    'pcs.sol6.dif4': 'Cumplimiento de normativas regulatorias',
    'pcs.sol6.dif5': 'Integración con almacenamiento y distribución',
    'pcs.sol6.dest1': 'Garantía de integridad de los productos',
    'pcs.sol6.dest2': 'Reducción de riesgos logísticos',
    'pcs.sol6.dest3': 'Control integral de extremo a extremo de la operación',

    'pcs.sol7.title': 'Servicios logísticos para SAC (Servicio de atencion al cliente)',
    'pcs.sol7.desc': 'Servicios especializados de atención y logística inversa/devolución de productos para el consumidor final.',
    'pcs.sol7.dif1':' Logística inversa y reembolso: recolección de productos directamente en el domicilio del paciente para devolución o cambio, y entrega de reemplazos o reembolsos',
    'pcs.sol7.dif2':' Almacenamiento de productos para garantizar agilidad en la distribución',
    'pcs.sol7.dif3':'Conciliación de productos reclamados para devolución al fabricante',
    'pcs.sol7.dif4':'Cadena logística con control de temperatura',
    'pcs.sol7.dif5':'Monitoreo en tiempo real',
    'pcs.sol7.dif6':'Cumplimiento de normas regulatorias',
    ...
    'pcs.sol8.title': 'Almacenamiento Especializado',
    'pcs.sol8.desc': 'Almacenamiento y distribución especializada de insumos y dispositivos médicos.',
    'pcs.sol8.dif1':'Logística especializada para entrega domiciliaria o a centros de salud',
    'pcs.sol8.dif2':'Monitoreo del transporte y condiciones del producto',
    'pcs.sol8.dif3':'Trazabilidad completa de la entrega',
    'pcs.sol8.dest1':'Comodidad y seguridad para el cliente final',
    'pcs.sol8.dest2':'Garantía de integridad del producto',
    'pcs.sol8.dest3':'Eficiencia en la última milla de entrega',
    ...
    'tis.sol1.desc': 'Soluciones integradas de logística de cadena de frío combinadas con sistemas de embalajes reutilizables de alto rendimiento Shield Box, diseñados para garantizar la estabilidad térmica y la integridad de productos sensibles a la temperatura.',
    'tis.sol1.dif1': 'Embalajes Shield Box calificados en múltiples tamaños y rangos de temperatura',
    'tis.sol1.dif2': 'Protocolos completos de calificación y reportes de desempeño (validación en condiciones de verano e invierno)',
    'tis.sol1.dif3': 'Desempeño térmico comprobado de hasta 96+ horas',
    ...
    'tis.sol2.dif3': 'Operaciones dedicadas a cadena de frío, incluyendo modelo de carga aérea en aeronaves de carga (Fly Cargo), integradas con sistemas de rastreo',
    ...
    'tis.sol3.dif1': 'Data loggers retornables con monitoreo en tiempo real de parámetros críticos',
    'tis.sol3.dif2': 'Data loggers USB de un solo uso',
    'tis.sol3.dif3': 'Monitoreo continuo de temperatura desde -200 °C hasta +200 °C',
    'tis.sol3.dif4': 'Alertas por desviaciones de temperatura y humedad',
    'tis.sol3.dif5': 'Integración con sistemas de trazabilidad mediante tecnología 4G certificada por ANATEL',
    'tis.sol3.dif6': 'Reportes automáticos en PDF e información para soporte a la toma de decisiones operativas',
    'tis.sol3.dif7': 'Plataforma Bip Track validada y en conformidad con requisitos regulatorios',
    'tis.sol3.dest1': 'Visibilidad operativa total en tiempo real',
    ...
    'saibamais': 'VER MÁS',
    'fechar': 'CERRAR',
    'diferenciais': 'Características principales',

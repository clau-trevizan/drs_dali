...
export default function DRS360() {
  ...
  return (
    ...
    <img src={drs360Hero} alt="DRS 360" className="block w-full h-auto min-h-[200px] rounded-t-[24px] lg:rounded-t-none lg:rounded-l-[32px] lg:rounded-tl-[40px] lg:rounded-bl-[40px]" />
    </div>
    ...
    <text className="botao" x="50" y="274" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func5.line5')}</text>
    </svg>
    </div>

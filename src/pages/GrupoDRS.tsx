...
export default function GrupoDRS() {
  ...
  return (
    ...
    {[1,2,3,4,5,6,7].map((i, idx) => (
      ...
      <text className="botao" x="57" y={i === 6 ? "220" : "195"} fontSize="20" fontWeight="400" fill="#008C79">{t(`grupo.impact.card${i}.desc1` in {} ? `grupo.impact.card${i}.desc1` : `grupo.impact.card${i}.desc1`)}</text>
      <text className="botao" x="57" y={i === 6 ? "245" : "220"} fontSize="20" fontWeight="400" fill="#008C79">{t(`grupo.impact.card${i}.desc2`)}</text>
      </svg>
      </SwiperSlide>
    ))}
    </Swiper>
    ...
    <foreignObject x="180" y="238" width="340" height="100%"><div class="botao" style="font-size: 20px; color: rgb(0, 0, 0); line-height: normal; margin-top: 15px;">{t('grupo.nossotime.svg.line1')}</div></foreignObject>
